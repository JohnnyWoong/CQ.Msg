    ...
    public class Event_PrivateMsg : IPrivateMessage
    {
        ...
        public void PrivateMessage(object sender, CQPrivateMessageEventArgs e)
        {
            try
            {
                ...
                string sqlstr = string.Format("INSERT INTO 'msg' VALUES (NULL, {0}, {1}, {2}, '{3}', '{4}')", e.CQApi.GetLoginQQ().Id, 0, e.FromQQ.Id, e.Message.Text, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));

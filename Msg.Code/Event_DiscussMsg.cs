    ...
    public class Event_DiscussMsg : IDiscussMessage
    {
        ...
        public void DiscussMessage(object sender, CQDiscussMessageEventArgs e)
        {
            try
            {
                ...
                string sqlstr = string.Format("INSERT INTO 'msg' VALUES (NULL, {0}, {1}, {2}, '{3}', '{4}')", e.CQApi.GetLoginQQ().Id, e.FromDiscuss.Id, e.FromQQ.Id, e.Message.Text, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
